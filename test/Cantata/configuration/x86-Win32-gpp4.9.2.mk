...
# Generated from Cantata configuration section: x86-Win32-gpp4.9.2
...
CANTATA_INSTALL_DIR := C:/qa_system/cantata
...
#
export SOURCE_FILE_EXTS := .c .C .wfc .WFC .Wfc .cc .Cc .CC .cpp .Cpp .CPP .cxx .Cxx .CXX .wfp .Wfp .WFP .i .I .ixx .Ixx .IXX 

#
# Extra dependency on this file (used in test makefiles)
#

EXTRA_DEPENDS := ../configuration/x86-Win32-gpp4.9.2.mk